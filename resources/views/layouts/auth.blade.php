...
<!--
نویسنده: ساتراس وب
محصولات نام: مترونیکمحصولات Version: 8.2.6
...
<base href="../../../" />
    ...
    <link href="{{ asset('assets/auth/plugins/global/plugins.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/auth/css/style.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
